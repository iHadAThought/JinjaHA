...
| TD-009 | Permanent API-fallback | JinjaHA | Intentional | HACS / arbitrary Python / CPython sandbox stay on `FallbackTemplateRenderer`. Documented HA helpers are implemented locally; only true Python/HACS gaps fall back |
